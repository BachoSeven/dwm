...
static Key keys[] = {
	...
	{ MODKEY,			XK_m,		spawn,		SHCMD("setsid -f kitty --class ncmpcpp -e ncmpcpp -s playlist -S visualizer; kunst --silent") },
	...
	// { 0, XF86XK_AudioMedia,		spawn,		SHCMD("setsid -f kitty --class ncmpcpp -e ncmpcpp -s playlist -S visualizer; kunst --silent") },
